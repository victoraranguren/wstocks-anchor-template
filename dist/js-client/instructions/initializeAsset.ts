...
export type InitializeAssetInstruction<
  ...
  TAccountOwnerAssetTokenAccount extends string | AccountMeta<string> = string,
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountOwner extends string
        ...
        : TAccountOwner,
      TAccountOwnerAssetTokenAccount extends string
        ? WritableAccount<TAccountOwnerAssetTokenAccount>
        : TAccountOwnerAssetTokenAccount,
...
export type InitializeAssetAsyncInput<
  ...
  TAccountOwnerAssetTokenAccount extends string = string,
...
> = {
  ...
  ownerAssetTokenAccount?: Address<TAccountOwnerAssetTokenAccount>;
...
> {
  ...
  const originalAccounts = {
    ...
    ownerAssetTokenAccount: {
      value: input.ownerAssetTokenAccount ?? null,
      isWritable: true,
    },
  ...
  if (!accounts.ownerAssetTokenAccount.value) {
    accounts.ownerAssetTokenAccount.value = await getProgramDerivedAddress({
      programAddress:
  ...
  return Object.freeze({
    accounts: [
      ...
      getAccountMeta(accounts.ownerAssetTokenAccount),
...
> = {
  ...
  accounts: {
    ...
    ownerAssetTokenAccount: TAccountMetas[4];
...
>(
  ...
  return {
    ...
    accounts: {
      ...
      ownerAssetTokenAccount: getNextAccount(),
